...
mixin _$PushMessage {
  ...
  PushOrigin get origin => throw _privateConstructorUsedError;
...
class _$PushMessageImpl extends _PushMessage {
  const _$PushMessageImpl({
    required this.id,
    required this.title,
    required this.body,
    required this.receivedAt,
    this.origin = PushOrigin.foreground,
  ...
  @override
  String toString() {
    return 'PushMessage(id: $id, title: $title, body: $body, receivedAt: $receivedAt, origin: $origin, data: $data)';
  }
