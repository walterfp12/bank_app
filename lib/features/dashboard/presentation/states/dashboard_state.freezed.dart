...
mixin _$DashboardState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(DashboardData data, bool fromCache) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(DashboardData data, bool fromCache)? loaded,
...
abstract class _$$DashboardLoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({DashboardData data, bool fromCache});
...
class __$$DashboardLoadedImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({Object? data = null, Object? fromCache = null}) {
    return _then(
...
class _$DashboardLoadedImpl implements DashboardLoaded {
  const _$DashboardLoadedImpl({required this.data, this.fromCache = false});
  ...
  @override
  String toString() {
    return 'DashboardState.loaded(data: $data, fromCache: $fromCache)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(data, fromCache);
  }
...
abstract class DashboardError implements DashboardState {
  const factory DashboardError({required final String message}) =
      _$DashboardErrorImpl;
